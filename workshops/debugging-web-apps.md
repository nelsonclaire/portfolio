...
- Get visibility (use `p` to inspect everything to help you hone in on the exact line. In feature tests, use `save_and_open_page` to check what the page looks like at any given point).
